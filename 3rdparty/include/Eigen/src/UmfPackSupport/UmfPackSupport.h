...
inline int umfpack_symbolic(SuiteSparse_long n_row,SuiteSparse_long n_col,
...
inline int umfpack_numeric( const SuiteSparse_long Ap[], const SuiteSparse_long Ai[], const double Ax[],
                            void *Symbolic, void **Numeric,
                            const double Control[UMFPACK_CONTROL],double Info [UMFPACK_INFO])
{
...
inline int umfpack_solve( SuiteSparse_long sys, const SuiteSparse_long Ap[], const SuiteSparse_long Ai[], const double Ax[],
                          double X[], const double B[], void *Numeric,
                          const double Control[UMFPACK_CONTROL], double Info[UMFPACK_INFO])
{
...
class UmfPackLU : public SparseSolverBase<UmfPackLU<_MatrixType> >
{
  ...
  public:
    ...
    inline StorageIndex rows() const { return mp_matrix.rows(); }
    inline StorageIndex cols() const { return mp_matrix.cols(); }
  ...
  protected:
    ...
    {
      m_fact_errorCode = umfpack_symbolic(mp_matrix.rows(),
                                          mp_matrix.cols(),
