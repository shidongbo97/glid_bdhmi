...
template<class T>
LogSpiral<T> fitSpiral(const vec2<T> &s0, const vec2<T> &s1, const vec2<T> &t0, const vec2<T> &t1) {
    ...
    vec2<T> t0Parallel(v0);
    vec2<T> t1Parallel(v1);
...
template<>
LogSpiral<double> fitSpiral(const vec2<double>&, const vec2<double>&, const vec2<double>&, const vec2<double>&);
template<>
LogSpiral<float> fitSpiral(const vec2<float>&, const vec2<float>&, const vec2<float>&, const vec2<float>&);
